...
diff_ckpt=300000
humanliff_path=$(pwd)"/.."
JOB_NAME="Synbody_185_view_1000_subject_triplane_${image_size}x${image_size}x27_ckpt_"$ckpt_num"_diff_steps_"$diff_steps"_cond_controlnet_scale_tv_loss_nineplane"
...
python -m torch.distributed.launch --nproc_per_node=1 --master_port $master_port scripts/triplane_sample_layered.py --log_dir $EXPS/$JOB_NAME --model_path $EXPS/$JOB_NAME/ema_0.9999_$diff_ckpt.pt $SAMPLE_FLAGS $MODEL_FLAGS $DIFFUSION_FLAGS --layer_index 0 --data_dir $humanliff_path/recon_NeRF/logs/Synbody_185_view_100_subject_triplane_256x256x27_mlp_2_layer_N_coarse_samples_128_fine_sample_128_no_human_sample_lr_5e-3_tri_plane_lr_1e-1_nineplane_scale_tv_loss_1e-2_l1_loss_5e-4/200000.tar --start_id $start_id $DATA_FLAGS

wait

python -m torch.distributed.launch --nproc_per_node=1 --master_port $master_port scripts/triplane_sample_layered.py --log_dir $EXPS/$JOB_NAME --model_path $EXPS/$JOB_NAME/ema_0.9999_$diff_ckpt.pt $SAMPLE_FLAGS $MODEL_FLAGS $DIFFUSION_FLAGS --sample_npz $EXPS/$JOB_NAME/samples_person_${num_samples}x27x256x256_ckpt_${diff_ckpt}_ema_start_id_$start_id.npz --layer_index 1 --data_dir $humanliff_path/recon_NeRF/logs/Synbody_185_view_100_subject_triplane_256x256x27_mlp_2_layer_N_coarse_samples_128_fine_sample_128_no_human_sample_lr_5e-3_tri_plane_lr_1e-1_nineplane_scale_tv_loss_1e-2_l1_loss_5e-4/200000.tar --start_id $start_id $DATA_FLAGS

wait 

python -m torch.distributed.launch --nproc_per_node=1 --master_port $master_port scripts/triplane_sample_layered.py --log_dir $EXPS/$JOB_NAME --model_path $EXPS/$JOB_NAME/ema_0.9999_$diff_ckpt.pt $SAMPLE_FLAGS $MODEL_FLAGS $DIFFUSION_FLAGS --sample_npz $EXPS/$JOB_NAME/samples_person_pant_${num_samples}x27x256x256_ckpt_${diff_ckpt}_ema_start_id_$start_id.npz --layer_index 2 --data_dir $humanliff_path/recon_NeRF/logs/Synbody_185_view_100_subject_triplane_256x256x27_mlp_2_layer_N_coarse_samples_128_fine_sample_128_no_human_sample_lr_5e-3_tri_plane_lr_1e-1_nineplane_scale_tv_loss_1e-2_l1_loss_5e-4/200000.tar --start_id $start_id $DATA_FLAGS

wait 

python -m torch.distributed.launch --nproc_per_node=1 --master_port $master_port scripts/triplane_sample_layered.py --log_dir $EXPS/$JOB_NAME --model_path $EXPS/$JOB_NAME/ema_0.9999_${diff_ckpt}.pt $SAMPLE_FLAGS $MODEL_FLAGS $DIFFUSION_FLAGS --sample_npz $EXPS/$JOB_NAME/samples_person_pant_shirt_${num_samples}x27x256x256_ckpt_${diff_ckpt}_ema_start_id_$start_id.npz --layer_index 3 --data_dir $humanliff_path/recon_NeRF/logs/Synbody_185_view_100_subject_triplane_256x256x27_mlp_2_layer_N_coarse_samples_128_fine_sample_128_no_human_sample_lr_5e-3_tri_plane_lr_1e-1_nineplane_scale_tv_loss_1e-2_l1_loss_5e-4/200000.tar --start_id $start_id $DATA_FLAGS
